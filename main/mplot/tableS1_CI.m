...
[seroprev_ch_mean_0 seroprev_ch_lb_0 seroprev_ch_ub_0 CI_mean CI_lb CI_ub] = plotI(resample_post, dat1, 1, [], mode);
CI_mean
CI_lb
CI_ub
...
[seroprev_ch_mean_0 seroprev_ch_lb_0 seroprev_ch_ub_0 CI_mean CI_lb CI_ub] = plotI(resample_post2, dat2, 1, [], mode);
CI_mean
CI_lb
CI_ub
...
function [seroprev_a_change_mean seroprev_a_change_lb seroprev_a_change_ub CI_mean CI_lb CI_ub] = plotI(post, dat, display, marker, mode)
