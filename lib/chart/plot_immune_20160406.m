function [ total_infecteds serodist_mat log CInfectedsT1T2 total_age_pop CInfectedsT2 CInfectedsT1 CInfecteds recovered_tot CINaiveInfecteds CIImmInfecteds CINaiveInfectedsFull CIImmInfectedsFull CITreInfectedsFull] = plot_immune( y, pars, times, strain, agegroup, display, marker )
...
if length(y(1,:))==160 || pars.maxi == 2
       ...
       [total_infecteds CInfecteds CINaiveInfecteds CIImmInfecteds CINaiveInfectedsFull CIImmInfectedsFull CITreInfectedsFull]= gen_total_infecteds_SR(y, times, pars, strain, agegroup);
end
