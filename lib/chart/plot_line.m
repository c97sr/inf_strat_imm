function [ total_infecteds serodist_mat log CInfectedsT1T2 total_age_pop] = plot_line( y, pars, times, strain, agegroup, marker )
...
%if exist('marker')
%    [AX,H1,H2] = plotyy(T',[susceptible_tot/total_age_pop recovered_tot/total_age_pop CInfecteds/total_age_pop],T',total_infecteds, 'plot');
%else
    [AX,H1,H2] = plotyy(T',[susceptible_tot/total_age_pop recovered_tot/total_age_pop],T',total_infecteds, 'plot'); 
%end
