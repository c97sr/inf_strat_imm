function [ titremat infectedtitremat] = gen_strain_titres( y, times, agestates, pars )
%return titre matrix for S + R without infected population
  ...
  for i=1:length(nots)
      ...
      for l=1:nostates
          ...
          for m = 1:pars.maxj
              for n = 1:pars.maxk
                %titremat(i,l) = titremat(i,l) + y(t,pars.arrSlu(a,l,m,n)) + y(t,pars.arrRlu(a,l,m,n)) +  y(t,pars.arrIlu(1,a,l,m,n));
